...
extern DECL   *make_procfunc_decl (IDENT *id, PROCFUNCDEF *p);
extern PROCFUNCDEF *make_profunc (DECLLIST *dl, TYPE *t, BLOCK *b);
...
extern TYPE *make_fieldlist_type (FIELDLIST *f);

/* FIELDLIST routines */

extern FIELD *make_field(IDENT *id, TYPE *t);
extern FIELDLIST *make_fieldlist(FIELD *f, FIELDLIST *flist);
...
extern STMTIF *make_stmtif (EXPR *test, STMT *th, STMT *el);

extern STMTREPEAT *make_stmtrepeat (EXPR *test, STMTLIST *slist);

extern STMTFOR *make_stmtfor (BINDING *b, EXPR *e1, EXPR *e2, STMT *s);
...
extern STMT *make_ifstmt (EXPR *test, STMT *th, STMT *el);

extern STMT *make_casestmt(EXPR *test, CASELIST *clist);

extern STMT *make_repeatstmt (EXPR *test, STMTLIST *slist);

extern STMT *make_forstmt (IDENT *id, EXPR *e1, EXPR *e2, STMT *s);

extern STMT *make_compstmt (STMTLIST *slist);
extern STMTLIST *make_stmtlist(STMT *s, STMTLIST *slist);

extern CASELIST *make_caselist (CASEARM *ca, CASELIST *clist);
extern CASEARM *make_casearm (EXPRLIST *el, STMT *s);
